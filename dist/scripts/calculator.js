...
const calculator = (() => {
  ...
  const checkRequiredOptions = (details) => {
    ...
    return (
      initialLoan <= maximumLoan && downPayment >= minimumDownPayment
    );
  };
